package ru.mirea.leontyevme.cryptoloader;
...
import ru.mirea.leontyevme.cryptoloader.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    private final String TAG = getClass().getSimpleName();
    private static int LoaderID = 1234;
    ...
    public void	onClickButton(View view) {
        ...
        try {
            ...
            LoaderManager.getInstance(this).initLoader(LoaderID, bundle, this).forceLoad();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
