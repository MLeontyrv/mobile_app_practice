package ru.mirea.leontyevme.looper;
...
import ru.mirea.leontyevme.looper.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Handler	mainThreadHandler =	new	Handler(Looper.getMainLooper())	{
            ...
            public void handleMessage(Message msg)	{
                Log.d(MainActivity.class.getSimpleName(),	"Задача выполнена, результат: " +
